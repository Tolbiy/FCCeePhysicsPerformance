...
def Load_RDF(Mode):
    ...
    Path = "/eos/experiment/fcc/ee/analyses_storage/flavor/Bs2TauTau/flatNtuples/winter2023/analysis_stage1_ee_noFilter/"
    ...
    #rdf = rdf.Define("has_dielectron","Check_dimuon_Presence(electron_OpeningAngle)")
    #rdf = rdf.Define("has_dielectron_SameSide","Check_dimuon_SameSide(electron_OpeningAngle,has_dielectron)")
    #rdf = rdf.Define("has_dielectron_SigHemi","Check_dimuon_SigHemi(dielectron_ind, electron_thrustangles,has_dielectron)")
    #rdf = rdf.Define("has_dielectron_OppositeCharges","Check_dielectron_Charges(dielectron_ind, electron_charge,has_dielectron)")
...
CutList = ["n_electrons > 1",
           "EVT_ThrustEmin_E < 38",
           "recoEmiss_e > 10",
           "EVT_ThrustEmin_Eneutral < 10",

           #dimuon system requirement
           "has_dielectron > 0", #/!\ Always required if want to study any other dimuon cuts
           "has_dielectron_SameSide > 0",
           "has_dielectron_SigHemi > 0",
           "has_dielectron_OppositeCharges > 0",
           "has_dielectron_Vertex == 0"
          ] 
